...
public class detail_post extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String body=intent.getStringExtra("body");//从上一个活动得到单子的类别
        String where=intent.getStringExtra("where");//从上一个活动得到单子的类别
        String time=intent.getStringExtra("time");//从上一个活动得到单子的类别
        String qq=intent.getStringExtra("qq");//从上一个活动得到单子的类别
        con=qq;
